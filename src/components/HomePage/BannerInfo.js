    ...
    <div className="BannerInfo row ">
      <div className="DescriptionBanner col-sm-12 col-md-6 mx-auto">
        ...
        <p>
          ...
          1500s,sino que tambien ingresó como texto de relleno en documentos
          electrónicos
        </p>
        {auth.tokenAuth ? (
          <Link
            to={`/compraproducto/${item.ID_ITEM}`}
          ...
          >
            <Button
              ...
              disableElevation
              onClick={() => {
                dispatch(getProductBuyAction(item));
              }}
            >
              comprar producto
            </Button>
      ...
      <div className="ImgBanner col-sm-12 col-md-6 mx-auto pb-4">
        {item.ID_CODBAR ? (
          <img src={`img/${item.ID_CODBAR}.jpg`} alt="img"></img>
        ) : (
